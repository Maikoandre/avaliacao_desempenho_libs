...
\begin{resumo} 
  ...
  objetivo consiste em avaliar a eficiência em tempo de execução e o consumo máximo de memória RAM em
  ...
  (warmup). Os resultados experimentais sugerem possíveis trade-offs entre as ferramentas: o Pandas 
  indicou maior demanda de memória em volumes maiores; o Polars e o DuckDB mostraram indícios de 
  maior eficiência de processamento e menor consumo de recursos sob as condições testadas; 
  enquanto o PySpark apresentou maior overhead de inicialização em ambientes restritos.
\end{resumo} 
...
\begin{abstract}
  ...
  independently using individual subprocesses, preceded by a warmup phase. The experimental results suggest potential trade-offs among the tools: Pandas indicated higher memory demands at larger volumes; Polars and DuckDB showed signs of higher processing efficiency and lower resource consumption under the tested conditions; while PySpark suggested higher initialization overhead in restricted environments.
\end{abstract}
